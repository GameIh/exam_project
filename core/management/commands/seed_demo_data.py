...
class Command(BaseCommand):
    ...
    def _subjects(self, users):
        return {
            ...
            "information_systems": Subject.objects.create(
                title="Информационные системы",
                description="Архитектура, жизненный цикл и проектирование информационных систем.",
                teacher=users["teacher"],
            ),
            "networks": Subject.objects.create(
                title="Компьютерные сети",
                description="Сетевые модели, адресация, протоколы и безопасность.",
                teacher=users["web_teacher"],
            ),
            "python": Subject.objects.create(
                title="Программирование на Python",
                description="Синтаксис Python, функции, коллекции и обработка исключений.",
                teacher=users["algo_teacher"],
            ),
        }
    ...
    def _questions(self, subjects):
        return {
            ...
            "is_lifecycle": self._single_choice_question(
                subjects["information_systems"],
                "С какого этапа обычно начинается жизненный цикл информационной системы?",
                [
                    "С анализа требований",
                    "С удаления системы",
                    "С резервного копирования",
                    "С публикации исходного кода",
                ],
                0,
                "До проектирования необходимо определить задачи и требования пользователей.",
            ),
            "is_architecture": self._single_choice_question(
                subjects["information_systems"],
                "Что описывает архитектура информационной системы?",
                [
                    "Компоненты системы и связи между ними",
                    "Только цветовую схему интерфейса",
                    "Только список пользователей",
                    "Только расписание резервного копирования",
                ],
                0,
                "Архитектура фиксирует основные части системы, их ответственность и взаимодействие.",
            ),
            "is_requirements": self._text_question(
                subjects["information_systems"],
                "Для чего собирают требования к информационной системе?",
                [
                    "чтобы определить функции и ограничения системы",
                    "определить функции и ограничения системы",
                ],
                "Требования задают ожидаемое поведение системы и условия её работы.",
            ),
            "networks_osi": self._single_choice_question(
                subjects["networks"],
                "Сколько уровней содержит эталонная модель OSI?",
                ["4", "5", "7", "8"],
                2,
                "Модель OSI включает семь уровней от физического до прикладного.",
            ),
            "networks_ip": self._single_choice_question(
                subjects["networks"],
                "Для чего используется IP-адрес?",
                [
                    "Для идентификации сетевого интерфейса в IP-сети",
                    "Для хранения пароля пользователя",
                    "Для разметки HTML-страницы",
                    "Для сжатия файлов",
                ],
                0,
                "IP-адрес позволяет определить отправителя или получателя пакета в сети.",
            ),
            "networks_dns": self._text_question(
                subjects["networks"],
                "Какую задачу решает DNS?",
                [
                    "преобразует доменные имена в ip адреса",
                    "сопоставляет доменные имена и ip адреса",
                ],
                "DNS помогает находить сетевые адреса по понятным доменным именам.",
            ),
            "python_list": self._single_choice_question(
                subjects["python"],
                "Какая коллекция Python является изменяемой и упорядоченной?",
                ["tuple", "list", "frozenset", "str"],
                1,
                "Список list сохраняет порядок элементов и позволяет их изменять.",
            ),
            "python_exception": self._single_choice_question(
                subjects["python"],
                "Какой блок используется для обработки исключения в Python?",
                ["if", "except", "match", "yield"],
                1,
                "Блок except обрабатывает исключения, возникшие внутри try.",
            ),
            "python_function": self._text_question(
                subjects["python"],
                "Каким ключевым словом объявляется функция в Python?",
                ["def"],
