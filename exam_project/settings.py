...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    "django-insecure-%-kn=s7dw$t2a=h*pejw5pp@+8q1pf^&xg7%_v_ekx6)as0&+x",
)
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "exam_db"),
        "USER": os.getenv("POSTGRES_USER", "exam_user"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "exam_pass"),
...
TIME_ZONE = os.getenv("TIME_ZONE", "Asia/Yakutsk")
USE_I18N = True
USE_TZ = True
